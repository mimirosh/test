...
api_v1.include_router(operators_router)    # => /api/v1/operators/...
api_v1.include_router(calls_router)        # => /api/v1/calls/...
api_v1.include_router(departments_router)  # => /api/v1/departments/...
